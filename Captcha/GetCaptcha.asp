...
'// YOUR PREFERENCES
Const MAX_NUMBER_OF_CHARACTERS = 5    '// How many characters in our CAPTCHA?
Const MAX_LENGTH_CSS_CLASSES = 12       '// How many characters in the CSS class names?
Const CAPTCHA_CHARACTER_FACTOR = 25  '// How many pixels are we moving each new character from left?
Const CAPTCHA_BOX_BORDER = "border: 0px solid #ccc;"   '// Style the div box holding the CAPTCHA.
Const CAPTCHA_BOX_WIDTH = 140              '// Width. This value should balance the number of characters and size.
Const CAPTCHA_BOX_HEIGHT = 30               '// Same as above.
...
m_arrTopPosition(1) = 5
m_arrTopPosition(2) = 5
m_arrTopPosition(3) = 5
m_arrTopPosition(4) = 5
...
Sub CreateJavascript()
    ...
    sJScript = sJScript & "<div id=""" & m_sNameOfWrapperDiv & """>" 

    For i = 0 To (MAX_NUMBER_OF_CHARACTERS - 1)
        sJScript = sJScript & "<span class=""" & m_arrClassNames(i) & """>" & _
                        m_arrCaptchaScreen(i) & "</span>"
    Next

    sJScript = sJScript & "</div>"

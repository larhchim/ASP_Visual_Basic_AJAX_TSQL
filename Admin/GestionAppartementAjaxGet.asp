...
%>
						...
						<tr>
							...
							<td align="center"  valign="center">:</td>
							<td align="left"    valign="center"><input type="text" name="TSup" id="TSup" readonly style="width:100%;" value="<%=Rs("Superficie")%>" /></td>
						</tr>
						<tr>
							<td align="left"    valign="center">Quote-part</td>
							<td align="center"  valign="center">:</td>
							<td align="left"    valign="center"><input type="text" name="TQPart" id="TQPart" readonly style="width:100%;" value="<%=Rs("QuotePart")%>" /></td>
						</tr>
						<tr>
							<td align="left"    valign="center">Activ&eacute;</td>
							<td align="center"  valign="center">:</td>
							<td align="left"    valign="center"><input type="checkbox" name="CBAct" id="CBAct" <%=IsChecked(Rs("Active"))%> /></td>
						</tr>

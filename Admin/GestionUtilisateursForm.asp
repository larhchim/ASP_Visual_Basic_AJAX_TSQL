...
<%
    ...
    Req = "ps_user_get_byid " & Session("IdUser")
        ...
        <!--<div class="jumbotron">-->
				<form name="CompteForm" id="CompteForm" action="GestionProfilAction.asp" method="post">
					<table align="center" border="0" cellspacing="0" cellpadding="0" style="width:360px;font-weight:bold;" id="TabForm">
						...
						<tr style="height:20px; font-size:1px">
                            <td align="center" valign="center" colspan="3">
                            	<b class="Titre_2"><u>Informations liées à mon compte</u></b><br><br>
                            </td>
                        </tr>
                        <tr style="height:20px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
                        ...
                        <tr height="25">
							...
							<td align="left" valign="center">
								<input type="text" name="TNom" id="TNom" maxlength="50" readonly style="width:210px;" value="<%=Nom%>" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						<tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
                        ...
                        <tr height="25">
							...
							<td align="center" valign="center">:</td>
							<td align="left" valign="center">
								<input type="text" name="TPrenom" id="TPrenom" maxlength="50" readonly style="width:210px;" value="<%=Prenom%>" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						 <tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
						...
						<tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">
                            	...
                            	<a class="btn btn-primary" href="#" name="BTModifierInfos"  id="BTModifierInfos" role="button" alt="Modifier mes infos" title="Modifier mes infos"  onclick="javascript:VerifInfos('info');">Modifier mes infos</a>
                            </td>
                        </tr>
					...
					<table align="center" border="0" cellspacing="0" cellpadding="0" style="width:360px;font-weight:bold;" id="TabForm">
						...
						<tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">
                            	<button name="BTModifierPass" id="BTModifierPass" type="button" class="btn btn-outline-primary" title="Modifier mon mot de passe"  alt="Modifier mon mot de passe" value ="Modifier mon mot de passe" onclick="javascript:VerifPass('pass');">Modifier mon mot de passe</button>
							</td>
                        </tr>
                        <tr style="height:30px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>

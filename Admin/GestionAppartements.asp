...
<html lang="fr">
    <head>
        ...
        <script type="text/javascript" src="JS/GestionAppartements.js"></script>
		<script lang="Javascript">
			function AjaxSendData(fichier) 
			{
				var xmlhttp, data='msg1=bonjour&msg2=Jennat' ;
			...
			function Save()
			{
				...
				//var cible = 'GestionAppartementAjaxSet.asp?IdUser=' + Id ;
                //AjaxSetData(cible);
						...
						<thead style="cursor:move;" id="DivDataHeader">
							<tr>
								<td align="center" valign="center"  colspan="3">
									<img  style="width:50px;margin-left:2px;" src="Images/Save.png" title="Sauvegarder" onclick="javascript:Save();"/>

					...
					<table align="center" border="0" cellspacing="0" cellpadding="0" style="width:360px;font-weight:bold;" id="TabForm">
                        ...
                        <tr height="25">
							...
							<td align="left" valign="center">
								<input type="date" name="Ttype" id="TNom" maxlength="50" readonly style="width:210px;" value="<%=Nom%>" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						<tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
                        ...
                        <tr height="25">
							...
							<td align="center" valign="center">:</td>
							<td align="left" valign="center">
								<input type="date" name="Tdesignation" id="TPrenom" maxlength="50" readonly  style="width:210px;" value="<%=Prenom%>" onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						 <tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
                        ...
                        <tr height="25">
                         ...
                         <tr height="25">
							...
							<td align="center" valign="center">:</td>
							<td align="left" valign="center">
							<input type="checkbox" name="TQuitus" id="TEmail" maxlength="50" style="width:210px;"  onclick="javascript:ChangeBackColor(this, col2);">
                        ...
                        <tr height="25">
							...
							<td align="left" valign="center">
								...
								<input type="checkbox" name="TActive" id="TEmail" maxlength="50" style="width:210px;"  onclick="javascript:ChangeBackColor(this, col2);">
							</td>
						</tr>
						 <tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">&nbsp;</td>
						...
						<tr style="height:10px; font-size:1px">
                            <td align="center" valign="center" colspan="3">
                            	...
                            	<a class="btn btn-primary" href="#" name="BTModifierInfos"  id="BTModifierInfos" role="button" alt="Modifier mes infos" title="Modifier mes infos"  onclick="javascript:VerifInfos('info');">modifier</a>
                            </td>
                        </tr>

...
%>
						...
						<tr>
							...
							<td align="center"  valign="center">:</td>
							<td align="left"    valign="center"><input type="text" name="TDE" id="TDE" style="width:100%;" value="<%=GetFormattedDate(DateEncaissement)%>" disabled /></td>
						</tr>
						<tr>
							<td align="left"    valign="center">Numero RIB</td>
							<td align="center"  valign="center">:</td>
							<td align="left"    valign="center">
						<input type="text" name="TRB" id="TRB" style="width:100%;" value="<%=IdRB%>" disabled />

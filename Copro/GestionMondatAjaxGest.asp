...
%>                     <input type="hidden" value='<%=Rs("IdMandat")%>' id="Mn">
						...
						<tr>
							...
							<td align="center"  valign="center">:</td>
							<td align="left"    valign="center"><input type="text" name="TRemarque" id="TRemarque" style="width:100%;" value="<%=Rs("Remarques")%>" disabled/></td>
						</tr>
						<tr>
							<td align="left"    valign="center">Quitus</td>
							<td align="center"  valign="center">:</td>
							<td align="left"    valign="center"><input type="checkbox" name="Quitus" id="Quitus" style="width:100%;" disabled <%=IsChecked(Rs("Quitus"))%>/></td>
						</tr>
						<tr>
							<td align="left"    valign="center">Active</td>
							<td align="center"  valign="center">:</td>
							<td align="left"    valign="center"><input type="checkbox" name="Active" id="Active" style="width:100%;" disabled <%=IsChecked(Rs("Active"))%>/></td>
						</tr>
<%
	Else

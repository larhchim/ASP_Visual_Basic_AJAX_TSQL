...
'Elseif(Session("PageTitle") = "Syndicat") Then
   ' li1 = ""
   ' li2 = ""
   ' li3 = ""
    'li4 = ""
                ...
                <ul class="navbar-nav">
                    ...
                    <!------Ismail------->
                      ...
                      <li class="nav-item dropdown <%=li1%>"  style="padding-right:30px;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown09">
                            <a class="dropdown-item" href="cotisations.asp" alt="Gérer mon compte" title="Gestion Cotisations">Visualiser Cotisations</a>
                            <a class="dropdown-item" href="depenses.asp" alt="Gérer mes annonces" title="Gestion depenses">Visualiser depenses</a>
                             <a class="dropdown-item" href="banque.asp" title="Gestion banque">Visualiser banque</a>
                            <a class="dropdown-item" href="budget.asp" title="Gestion budget annuel">Visualiser budget Annuel</a>
                            <a class="dropdown-item" href="mandat.asp" title="Gestion Mandat">Visualiser Mandat</a>

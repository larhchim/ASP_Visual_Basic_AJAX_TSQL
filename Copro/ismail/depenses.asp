		...
		<main role="main" class="container">
					...
					<tr height="35">
						<td align="center" valign="center">
							<select name="LCriteres" id="LCriteres" style="width:120px;">
								<option value="App">Date</option>
								<option value="Nom">Annee</option>
                                <option value="Nom">Montant</option>
							</select>
							&nbsp;&nbsp;
			...
			<div class="DivScroll">
				<table align="center" border="0" id="TabScroll">
					<thead>
						<tr>
							<td align="center"  valign="center"  style="width:33%;">Date Depense</td>
							<td align="center"  valign="center"  style="width:33%;" id="LabCpt">Annee</td>
							<td align="center"  valign="center"  style="width:33%;">Montant</td>
						</tr>
					</thead>

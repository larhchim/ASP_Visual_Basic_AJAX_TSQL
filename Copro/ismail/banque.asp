		...
		<main role="main" class="container">
				...
				<thead>
					<tr height="35">
						<td align="center" valign="center">
							...
							Recherche:<input type="text" name="TVal" id="TVal" value="" style="width:120px;" onkeypress="javascript:Valider();">
							&nbsp;&nbsp;
			...
			<div class="DivScroll">
				<table align="center" border="0" id="TabScroll">
					<thead>
						<tr>
                            <td align="center"  valign="center"  style="width:20%;" id="LabCpt">Annee</td>
							<td align="center"  valign="center"  style="width:20%;">Mois</td>
							<td align="center"  valign="center"  style="width:20%;" id="LabCpt">ToTal Entree</td>
                            <td align="center"  valign="center"  style="width:20%;" id="LabCpt">ToTal Sortie</td>
							<td align="center"  valign="center"  style="width:20%;">Solde</td>
						</tr>
					</thead>
					<tbody id="TabScrollBody"> </tbody>
					<tfoot><tr><td align="center" valign="center" colspan="5"></td></tr></tfoot>
				</table>
			</div>
			<div id="DivDragDrop">
				<div id="DivData">

				...
				<thead>
					<tr height="35">
						<td align="center" valign="center">
							...
							Rechercher:<input type="text" name="TVal" id="TVal" value="" style="width:120px;" onkeypress="javascript:Valider();">
							&nbsp;&nbsp;
				...
				<table align="center" border="0" id="TabScroll">
					<thead>
						<tr>
							...
							<td align="center"  valign="center"  style="width:25%;" id="LabCpt">Global Encaissé</td>
							<td align="center"  valign="center"  style="width:25%;">Global Depensé</td>
						</tr>
					</thead>
